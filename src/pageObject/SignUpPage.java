...
public class SignUpPage extends BasePage {
    ...
    By checkBox_IAgree = By.cssSelector("div#ember1893");
    By checkBox_ReceivingMailings = By.cssSelector("div#ember1895");
    ...
    public SignUpPage clickCheckBox_ReceivingMailings(){
        if (!selected(checkBox_ReceivingMailings))
            click(checkBox_ReceivingMailings);
        return this;
    }
